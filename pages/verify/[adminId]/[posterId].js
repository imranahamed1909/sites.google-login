...
export default function Home() {
  ...
  return (
    <>
    {
      !homepage?( <div className="">
      <div className="relative">
      <p className="absolute top-[40%] left-[35%] text-7xl text-white font-extralight">Google Meet</p>
    <img class="w-full bg-[#226e93] object-cover h-[340px]" src="/images/cover.png" alt="Flower and sky"/>
      </div>
     <div className="flex flex-col m-5 justify-center items-center ">
     <img class="w-[365px] h-[365px] " src="/images/google-duo-logo.png" alt="logo"/>
     <button className="w-[365px] bg-[#226e93] text-white px-3 py-1 rounded-sm m-5" onClick={()=>setHomepage(true)}>Google Meet</button>
     </div>
  </div>):(<div className="relative text-black h-screen w-screen flex flex-col justify-center items-center">
